...
INSERT INTO settings (id, usd_rate, markup_rub_default, fee_percent, pp_price_usd, pp_markup_rub, ticket_price_usd, ticket_markup_rub, prime_markup_rub, prime_plus_markup_rub, uc_60_price_usd) 
VALUES (1, 78.0, 260.0, 0.052, 0.1, 0, 0.01, 0, 0, 0, 1.0)
...
ALTER TABLE settings ADD COLUMN IF NOT EXISTS uc_60_price_usd FLOAT8 DEFAULT 1.0;