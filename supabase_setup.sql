...
-- Удаление существующих таблиц (с проверкой)
DROP TABLE IF EXISTS codes_stock CASCADE;
DROP TABLE IF EXISTS products CASCADE;
DROP TABLE IF EXISTS settings CASCADE;
DROP TABLE IF EXISTS orders CASCADE;
DROP TABLE IF EXISTS midas_accounts CASCADE;
DROP TABLE IF EXISTS pp_products CASCADE;
DROP TABLE IF EXISTS skins_products CASCADE;
